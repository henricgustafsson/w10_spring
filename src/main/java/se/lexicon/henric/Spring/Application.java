...
public class Application {
	...
	public static void main(String[] args) {
		 ...
		 *
		 * Testat med qualifier gav exception:
		 * Exception in thread "main" org.springframework.beans.factory.UnsatisfiedDependencyException:
		 * Error creating bean with name 'scannerInputService': Unsatisfied dependency expressed through method 'setScanner' parameter 0;
		 * nested exception is org.springframework.beans.factory.NoSuchBeanDefinitionException: No qualifying bean of type 'java.util.Scanner' available:
